...
def pytest_runtest_makereport(item, call):
    ...
    if report.when == 'call':
        from common.globals import file_path
...
#     if inspect.isclass(obj) and issubclass(obj, object):
...
def set_capabilities(setup_logging):
    ...
    if globals_contents.target_environment == strings.ANDROID:
        ...
        desired_capabilities['appWaitDuration'] = '70000'
        ...
        # desired_capabilities['deviceId']= '172.16.11.109:5555'
