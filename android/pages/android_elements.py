...
Course_name = 'org.edx.mobile:id/course_name'
Course_detail_name = 'org.edx.mobile:id/course_detail_name'
share_course = 'org.edx.mobile:id/menu_item_share'
Course_content_tab = 'Python Basics for Data Science'
vedio_tab = 'Videos'
Discussion_tab = 'Discussion'
Important_dates = 'Important Dates'
Resources = 'Resources'
Course_header_image = 'org.edx.mobile:id/header_image_view'
Last_accessed_bar = 'org.edx.mobile:id/last_accessed_bar'
Last_accessed_view_button = 'org.edx.mobile:id/last_accessed_button'
Welcome_section = 'org.edx.mobile:id/row_header'
course_content_list = 'org.edx.mobile:id/chapter_row_layout'
discussion_topic_name = 'org.edx.mobile:id/discussion_topic_name_text_view'
next_vedio_button = 'org.edx.mobile:id/goto_next'
previous_vedio_button = 'org.edx.mobile:id/goto_prev'



#demotestcode

graphic_tab = 'android:id/text1'
