...
class Globals(object):
    ...
    WEB_VIEW_FIND_COURSES_ACTIVITY_NAME = '.view.DiscoveryActivity'
    ...
    # course dashboard activities
    course_content_detail_activity = '.view.CourseOutlineActivity'
    course_content_unit_navigation_activity = '.view.CourseUnitNavigationActivity'
    course_discussion_post_activity = '.view.CourseDiscussionPostsActivity'
    course_hangout_activity = '.view.CourseHandoutActivity'
    course_announcement_Activity = '.view.CourseAnnouncementsActivity'
    course_tab_dashboard_activity = '.view.CourseTabsDashboardActivity'

    # def screenshot(self, driver, name, screenshots_directory):
    #     from conftest import screenshots_directory
    #     time = driver.get_device_time()
    #     global file_path
    #     file_path = screenshots_directory + "/" + name + ".png"
    ...
    def __init__(self, project_log):
        ...
        # self.remote_ip = '172.16.11.109:5555'
    ...
    def scroll_to_search_element(self, driver, element_locator):
        """
        Block and scroll until the element present on screen, then returns the element
        ...
        try:
            if self.target_environment == strings.ANDROID:
                element = self.wait_and_get_element_minimum_timeout(driver, element_locator)

                while element is None:
                    driver.swipe(470, 1400, 470, 1000, 800)
                    element = self.wait_and_get_element_minimum_timeout(driver, element_locator)
