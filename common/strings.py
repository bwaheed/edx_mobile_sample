...
LOGIN_RESET_PASSWORD_ALERT_MSG = 'Enter the e-mail address for your account, and we\'ll send you instructions to reset your password. '
...
# Course Dashboard
LAST_ACCESSED_BUTTON = 'View'
NEXT_VEDIO_BUTTTON = 'Next'
PREVIOUS_VEDIO_BUTTON = 'Previous'